...
/**
 * @author Sicheng Zhu
 * This test case validates EmployerForAPOrCurrWithSecCert text field with no input.
 */
public class TestCaseRF45 {
	public static void main(String[] args) {                
        ...
        try {        	
            ...
            User.inputToField(driver, User.getWholeFormTestDataTagName()[22], "");
            Thread.sleep(1000);            
