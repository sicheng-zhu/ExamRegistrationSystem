...
public class TestCaseRF25 {
	public static void main(String[] args) {                
        ...
        try {        	
            ...
            User.inputToField(driver, User.getWholeFormTestDataTagName()[2], "临床医学综合导论（Ａ类）");
            Thread.sleep(1000);            
            User.clickSubmitButton(driver);
            Thread.sleep(3000);
            ...
            User.inputToField(driver, User.getWholeFormTestDataTagName()[2], "临床医学综合导论临床医学综合导论临床医学综合导论"
            ...
            User.inputToField(driver, User.getWholeFormTestDataTagName()[2], "临床医学综合导论");
            Thread.sleep(1000);            
            User.clickSubmitButton(driver);
            Thread.sleep(10000);
