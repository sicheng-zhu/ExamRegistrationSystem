...
/**
 * @author Sicheng Zhu
 * This test case validates StartingEmploymentDate text field with no input.
 */
public class TestCaseRF46 {
	public static void main(String[] args) {                
        ...
        try {        	
            ...
            User.inputToField(driver, User.getWholeFormTestDataTagName()[23], "");
            Thread.sleep(1000);            
